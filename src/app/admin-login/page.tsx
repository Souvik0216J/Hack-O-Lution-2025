...
export default function SignupForm() {
  ...
  return (
    <div className="min-h-screen w-full rounded-md flex flex-col items-center justify-center px-4 py-6 sm:px-6 lg:px-8">
      <Spotlight />
      <div className="shadow-input mx-auto w-full max-w-md rounded p-4 md:rounded-2xl md:p-8 bg-black">
        <h2 className="text-xl font-bold text-neutral-200">
          HACK&#123;<span className="text-green-400">0</span>&#125;LUTION Admin Login
        </h2>
        ...
        <form className="my-8" onSubmit={handleSubmit}>
          ...
          >
            {loading ? (
              <>
                <Loader className="inline w-6 h-6 text-blue-400 animate-spin"/> Processing...
              </>
            ) : (
              <>
                Login &rarr;
